Here is your complete **Apache Directory Listing Security Configuration Guide converted for CentOS**, keeping the **exact structure and numbering** intact, with all necessary adjustments for CentOS (e.g., `httpd` instead of `apache2`, file paths, service names, and ownership):

---

## ✅ Apache Directory Listing Security Configuration Guide for CentOS
