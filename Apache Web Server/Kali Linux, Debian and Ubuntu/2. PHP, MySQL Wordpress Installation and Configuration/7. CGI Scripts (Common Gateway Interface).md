...
### Set Ownership and Permissions
```bash
 chown www-data:www-data /usr/lib/cgi-bin/mem.cgi
...
### Set Ownership and Permissions
```bash
 chown www-data:www-data /usr/lib/cgi-bin/ping.cgi
...
### Create `script.cgi`
```bash
 nano /usr/lib/cgi-bin/script.cgi
...
### Create `script2.cgi`
```bash
 nano /usr/lib/cgi-bin/script2.cgi
 chmod +x /usr/lib/cgi-bin/script2.cgi
