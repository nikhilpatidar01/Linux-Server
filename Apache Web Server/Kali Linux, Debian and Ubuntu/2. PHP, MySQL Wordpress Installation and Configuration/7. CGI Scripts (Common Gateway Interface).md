Here's your **converted and corrected guide** for **CGI scripts on Kali Linux / Ubuntu / Debian-based systems**, matching the structure of your CentOS/RHEL version:
